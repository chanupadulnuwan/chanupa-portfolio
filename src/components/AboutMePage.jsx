...
const certificationsData = [
  ...
  {
    id: 2,
    title: "Professional IT & Software Engineering Certificate",
    issuer: "Academic & Professional Certification",
    image: cert2
  },
  {
    id: 3,
    title: "Pearson Level 3 Diploma in IT (Distinction)",
    issuer: "Pearson / Horizon Campus",
    image: cert3
  },
  {
    id: 4,
    title: "UI/UX & Designathon 2026 Recognition",
    issuer: "Altrium / APIIT Sri Lanka",
    image: cert4
  },
  {
    id: 5,
    title: "Technical & Software Architecture Certificate",
  ...
  return (
    <div className="about-me-page">
      ...
      <header className="about-page-header">
        <div className="container header-content">
          ...
          <div className="motto-badge">
            <Sparkles size={14} color="#FD6F00" />
            <span>Ascende Superius — Seek Higher Things</span>
          </div>
        </div>
      </header>
      ...
      <main className="about-page-main container">
          ...
          <div className="about-hero-text-col">
            ...
            <div className="story-highlights-grid">
              <div className="highlight-pill">
                <Music size={16} color="#FD6F00" />
                <span>Ex-School Orchestra Leader & All-Island Winner</span>
              </div>
              <div className="highlight-pill">
        ...
        {/* Chapter 1: Early Foundation & School Leadership */}
        <div className="story-chapter-card">
          <div className="chapter-icon-wrapper">
            <Music size={24} color="#FD6F00" />
          </div>
          <div className="chapter-content">
            <h3 className="chapter-title">Early Foundation & Leadership at Siridhamma College</h3>
            <p className="chapter-paragraph">
              I began my education at <strong>Siridhamma College, Galle</strong>, where I studied from Grade 1 through my Advanced Levels. During my school years, music became an important part of my life. I was actively involved in the school orchestra and, in 2021, had the privilege to become its leader.
            </p>
            <p className="chapter-paragraph">
